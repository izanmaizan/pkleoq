...
<body>
    ...
    loginForm.addEventListener('submit', function(e) {
        ...
        if (!username || !password) {
            ...
            // Show error message (you can integrate with SweetAlert2 here)
    ...
    /*
    setTimeout(() => {
        showAlert('error', 'Login Gagal', 'Username atau password yang Anda masukkan salah. Silakan coba lagi.');
    }, 3000);
    */
    </script>
