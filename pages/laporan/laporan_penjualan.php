<!-- pages/laporan/laporan_penjualan.php   -->
<?php
session_start();
...
<head>
    ...
    <meta name="description" content="Laporan Penjualan - Sistem EOQ PT Wings Group Indonesia">
    <meta name="author" content="PT Wings Group Indonesia">

    <title>EOQ - Laporan Penjualan | PT Wings Group</title>
    ...
    <link rel="stylesheet"
        href="<?php echo ($_SESSION['role'] == 1) ? '../karyawan/style.css' : 'style-laporan.css'; ?>">
            ...
            <li class="nav-item active">
                ...
                <div id="report" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="laporan_penjualan.php">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <p class="mb-0 opacity-75">
                                    Laporan komprehensif transaksi penjualan PT Wings Group Indonesia
                                </p>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="export-section mb-4">
                                <div class="export-buttons">
                                    <a href="../reports/export-penjualan-excel.php?dari=<?= isset($dari) ? $dari : '' ?>&sampai=<?= isset($sampai) ? $sampai : '' ?>"
                                    ...
                                    <a href="../reports/export-penjualan-pdf.php?dari=<?= isset($dari) ? $dari : '' ?>&sampai=<?= isset($sampai) ? $sampai : '' ?>"
                                ...
                                <table class="table table-hover" id="tblPenjualan" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><i class="fas fa-calendar me-1"></i> Tanggal Penjualan</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><code class="text-primary"><?= $data['kd_transaksi'] ?></code></td>
                                            <td>
            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h6 class="modal-title title text-white" id="detailModalLabel">
                        <i class="fas fa-info-circle me-2"></i> Detail Transaksi Penjualan
                    </h6>
                    <button class="close text-white" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless detail-info-table">
                                <tbody>
                                    <tr>
                                        <td class="font-weight-bold text-primary">
                                            <i class="fas fa-store me-2"></i> Customer
                                        </td>
                                        <td>:</td>
                                        <td><span id="customer" class="font-weight-bold"></span></td>
                                    </tr>
                                    <tr>
                                        <td class="font-weight-bold text-primary">
                        ...
                        <table class="table table-hover detail-items-table" id="detailTable">
                            <thead>
                                <tr>
                                    ...
                                    <th><i class="fas fa-shipping-fast me-1"></i> Stock Keluar</th>
                            ...
                            <tfoot>
                                <tr class="total-row">
                                    <td class="text-center font-weight-bold" colspan="4">
                                        <i class="fas fa-calculator me-2"></i> Total Penjualan
                                    </td>
    ...
    $(document).on('click', '#btn-detail', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#customer').html('Customer Umum'); // Bisa disesuaikan jika ada data customer
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    tableRows += '<td><span class="text-primary font-weight-bold">' + rowData
                        .stock_out + ' ' + rowData.nama_satuan + '</span></td>';
