...
<head>
    ...
    <title>EOQ - Satuan | PT Wings Group</title>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <p class="mb-0 opacity-75">
                                    Kelola satuan ukuran produk PT Wings Group untuk standardisasi inventory
                                </p>
                            </div>
                            <div class="d-none d-lg-block">
                                <i class="fas fa-ruler fa-3x opacity-25"></i>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card form-card card-stats shadow">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold">
                                        <i class="fas fa-plus-circle me-2"></i> Form Satuan
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <form id="formSatuan">
                                        <div class="form-group">
                                            ...
                                            <label for="nm_satuan">
                                                <i class="fas fa-balance-scale me-1"></i> Nama Satuan
                                            </label>
                                            <input type="text" class="form-control" id="nm_satuan" name="nm_satuan"
                                                placeholder="Contoh: Kg, Liter, Pcs, Box">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="keterangan" name="keterangan" rows="4"
                                                placeholder="Masukkan keterangan satuan (opsional)"></textarea>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" form="formSatuan" class="btn btn-primary btn-sm"
                                        id="btnSimpan">
                                        <i class="fas fa-save me-1"></i> Simpan
                                    </button>
                                    <button type="reset" form="formSatuan" class="btn btn-secondary btn-sm">
                        ...
                        <div class="col-lg-8 col-md-7">
                            <div class="card table-card card-stats shadow">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold">
                                            <i class="fas fa-list me-2"></i> Daftar Satuan
                                        </h6>
                                        <span class="badge badge-light">
                                            <i class="fas fa-ruler me-1"></i> Unit Measurement
                                        </span>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="tblSatuan" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th width="50"><i class="fas fa-hashtag me-1"></i> No</th>
                                                    <th><i class="fas fa-balance-scale me-1"></i> Nama Satuan</th>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return '<span class="font-weight-bold text-primary"><i class="fas fa-balance-scale me-2"></i> ' +
                            data + '</span>';
                    }
                },
                {
