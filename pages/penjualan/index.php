...
<head>
    ...
    <title>EOQ - Penjualan | PT Wings Group</title>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <p class="mb-0 opacity-75">
                                    Kelola transaksi penjualan produk PT Wings Group Indonesia
                                </p>
                            </div>
                ...
                if (data && data.length > 0) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        tableRows += '<td><span class="font-weight-bold">' + (rowData.nama_produk ||
                            '-') + '</span></td>';
                        tableRows += '<td><span class="badge badge-warning">' + (rowData
                                .stock_out || '0') + ' ' + (rowData.nama_satuan || '') +
                            '</span></td>';
